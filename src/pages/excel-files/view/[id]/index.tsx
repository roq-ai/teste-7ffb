...
import { getExcelFileById } from 'apiSdk/excel-files';
...
function ExcelFileViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ExcelFileInterface>(
    ...
    () =>
      getExcelFileById(id, {
        relations: ['user', 'organization', 'assignment'],
      }),
  );
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Excel File Detail View
          </Text>
          {hasAccess('excel_file', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/excel-files/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('assignment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/assignments/create?excel_file_id=${data?.id}`}>
